...
class Main
{
  ...
  static public function getNewDirStructure()
  {
    ...
    foreach ($files1 as $key => $value) {
      ...
      if (
        ...
        $item[self::$type] = Functions::getProjectType($value);
  ...
  static public function fetchDetection()
  {
    ...
    if (isset($_POST['clear_data_base']) && isset($_POST['type'])) {
      Functions::clearDb($_POST['clear_data_base'], $_POST['type']);
    }

    if (isset($_POST['show_modules']) && isset($_POST['type'])) {
      Functions::showModules($_POST['show_modules'], $_POST['type']);
    }
    ...
    if (isset($_POST['remove_project'])) {
      Functions::removeCatalog($_POST['remove_project']);
    }
  }
}
